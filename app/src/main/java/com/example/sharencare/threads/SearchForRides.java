...
import static com.example.sharencare.ui.TripDetailsDriver.userLocation;


public class SearchForRides extends AsyncTask<Void ,Void, ArrayList<UserLocation>> {
    ...
    private SearchForTripsInterface searchForTripsInterface;
    ...
    public SearchForRides(SearchForTripsInterface searchForTripsInterface, Context mContext, String tripFrom, String tripTo) {
        this.searchForTripsInterface = searchForTripsInterface;
